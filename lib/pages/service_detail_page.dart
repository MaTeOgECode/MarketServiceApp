  ...
  void _enviarCalificacion() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        if (!snapshot.exists) {
          throw Exception(
            "El servicio con ID ${widget.servicio.id} no existe en la base de datos.",
          );
        }
        ...
        if (data.containsKey('promedioEstrellas') &&
            data['promedioEstrellas'] != null) {
        ...
        double nuevoPromedio =
            ((promedioActual * votosTotales) + _ratingSeleccionado) /
            nuevosVotos;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("¡Calificación publicada!"),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (widget.estadoReserva == "pendiente" &&
                          widget.contratacionId != null)
                        _buildConfirmButton()
  ...
  Widget _buildRatingInfo(bool isDark) {
    return Row(
      children: [
        ...
        Text(
          widget.servicio.rating.toStringAsFixed(1),
          style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
        ),
        Text(
          " (${widget.servicio.reviews} reseñas)",
      ...
      children: [
        ...
        Row(
          ...
          children: List.generate(
            ...
            (index) => IconButton(
              icon: Icon(
                index < _ratingSeleccionado ? Icons.star : Icons.star_border,
                color: Colors.amber,
                size: 40,
              ),
              onPressed: () =>
                  setState(() => _ratingSeleccionado = index + 1.0),
            ),
          ),
        ),
        const SizedBox(height: 15),
        TextField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: isDark ? darkInput : Colors.white,
  ...
  Widget _buildAvisoPendiente(bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? darkInput : Colors.grey[200],
        borderRadius: BorderRadius.circular(12),
      ),
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              "Podrás calificar cuando el servicio se complete.",
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  "Bs ${widget.servicio.precioValor.toStringAsFixed(0)}",
